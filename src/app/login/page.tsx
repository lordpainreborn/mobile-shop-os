      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className={`text-xs font-semibold uppercase tracking-widest ${desktop ? "text-slate-400" : "text-slate-400"}`}>
              or
            </span>
            <div className="flex-1 h-px bg-slate-200" />
          </div>
          ...
          <button
            ...
            className={`w-full flex items-center justify-center gap-3 rounded-xl px-4 py-3 text-sm font-semibold transition shadow-sm ${
              desktop
                ? "bg-white text-slate-800 border border-slate-600 hover:bg-slate-100"
